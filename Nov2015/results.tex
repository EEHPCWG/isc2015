...
\begin{figure}[ht!]
\begin{center}
\frame{\includegraphics[scale=0.6]{figs/loadgraphUS.pdf}}
\caption{Total Load at at SCs in United States}
\label{fig:USload}
\vspace{0.9cm}
\frame{\includegraphics[scale=0.6]{figs/loadgraphEU.pdf}}
...
\begin{figure}[ht!]
\begin{center}
\frame{\includegraphics[scale=0.6]{figs/vargraphUS.pdf}}
\caption{Maximum Variability at at SCs in United States}
\label{fig:USvar}
\vspace{0.9cm}
\frame{\includegraphics[scale=0.6]{figs/vargraphEU.pdf}}
